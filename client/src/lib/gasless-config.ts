export const GASLESS_CONFIG = {
  ...
  relayerUrl: `${import.meta.env.VITE_RELAYER_URL || "https://achswapv3.vercel.app"}/api/relay`,
  nonceUrl: `${import.meta.env.VITE_RELAYER_URL || "https://achswapv3.vercel.app"}/api/nonce`,
};
